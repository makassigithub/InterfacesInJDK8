...
public class TestClass_1 {
	...
	public static void main (String...args){
		...
		System.out.println("Targetting: " + ss.showTagettedPublic("Teenagers"));
		...
		//If whereAmI() is not overridden in WeekendShow neither, calling it on ss return the version of TVshow the top superclass.
		  ss.whereAmI();
